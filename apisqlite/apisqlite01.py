...
def movielookup(mykey, searchstring, mediatype=None):
    ...
    while True:
        ...
        if answer in ["1", "2"]:
            ...
            if answer == "1":
                ...
                mediatype = input("enter a type (movie, series or episode): ") # maybe you can write this code!
                resp = movielookup(mykey, searchstring, mediatype)                                 # restart the while loop
            if resp:
                # display the results
