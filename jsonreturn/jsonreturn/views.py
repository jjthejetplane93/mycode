...
def read_fortune(request):
    ...
    if num < 5 :
        response_data['daily outlook'] = 'Be carefu, today is not your day'

    if num >= 5 and num < 10 :
        response_data['daily outlook'] = 'today will be a normal day for you'
    
    if num == 10 :
        response_data['daily outlook'] = 'today is your lucky day!!!'
